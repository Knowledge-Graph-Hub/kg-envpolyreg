...
import click
from kg_envpolyreg import download as kg_download
from kg_envpolyreg import transform as kg_transform
#from kg_envpolyreg.make_holdouts import make_holdouts
from kg_envpolyreg.merge_utils.merge_kg import load_and_merge
from kg_envpolyreg.query import run_query, parse_query_yaml, result_dict_to_tsv
from kg_envpolyreg.transform import DATA_SOURCES
...
def transform(*args, **kwargs) -> None:
    """Calls scripts in kg_envpolyreg/transform/[source name]/ to transform each source
